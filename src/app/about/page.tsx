    ...
    <div className="min-h-screen bg-gradient-to-br from-[#020817] via-[#0a1020] to-[#020817]">
      <section className="relative pt-32 pb-20 text-center overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-8">
          ...
          <p className="font-outfit text-xl text-slate-400 leading-relaxed max-w-2xl mx-auto">
      ...
      <section className="max-w-7xl mx-auto px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <div className="space-y-4 font-outfit text-slate-400 leading-relaxed text-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={t} className="glass rounded-2xl p-6 border border-slate-800 hover-lift hover-glow-green transition-all">
                ...
                <h3 className="font-playfair text-base font-bold text-white mb-1">{t}</h3>
                <p className="font-outfit text-xs text-slate-400 leading-relaxed">{d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 max-w-4xl mx-auto px-8">
        <h2 className="font-playfair text-3xl font-bold text-white text-center mb-10">Our <span className="shimmer-green">Products</span></h2>
          ...
          {products.map(p => (
            <div key={p.id} className="glass rounded-3xl p-8 border border-slate-800 text-center hover-lift hover-glow-green transition-all group">
              ...
              <a href={p.affiliateLink} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-5 py-2.5 btn-primary rounded-xl text-white font-outfit font-semibold text-sm">
